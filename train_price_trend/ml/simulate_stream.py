...
def parse_args():
    ...
    p.add_argument("--edge-thresh", type=float, default=0.002)  # <-- more realistic default
    ...
    p.add_argument("--ev-mode", choices=["mtm","settlement"], default="mtm")  # <-- NEW
